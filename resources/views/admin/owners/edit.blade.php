                        ...
                        <div class="container px-5 mx-auto">
                          ...
                          <form method="post" action="{{ route('admin.owners.update', ['owner' => $owner->id]) }}">
                            ...
                            <div class="-m-2">
                              ...
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                  <label for="team" class="leading-7 text-sm text-gray-600">Team</label>
                                  <div class="w-full bg-gray-100 bg-opacity-50 rounded focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $owner->team->name }}</div>
                                </div>
                              </div>
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                              ...
                              <div class="p-2 w-full flex justify-around mt-4">
                                ...
                                <button type="submit" class=" text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Edit</button>
                              </div>
                            </div>
                          </form>
                          </div>
